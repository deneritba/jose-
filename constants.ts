...
const IMG_CH_1_TO_10 = "https://zygyapadihekebhhbges.supabase.co/storage/v1/object/sign/jose%20do%20egito/1oa10%20correta.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85NDUyOTA3Yi0zMWRmLTQ2ZTMtOTA4NS03OGQ4MjdmYmIyMmYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJqb3NlIGRvIGVnaXRvLzFvYTEwIGNvcnJldGEucG5nIiwiaWF0IjoxNzY4Mzk1MTQwLCJleHAiOjIwNTIyMTkxNDB9.ET8OesV43IUqd1lapNBr8qG6OT2dWME-Kt1ufBflKOs";

const IMG_CH_11_TO_20 = "https://zygyapadihekebhhbges.supabase.co/storage/v1/object/sign/jose%20do%20egito/11ao20%20correta.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85NDUyOTA3Yi0zMWRmLTQ2ZTMtOTA4NS03OGQ4MjdmYmIyMmYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJqb3NlIGRvIGVnaXRvLzExYW8yMCBjb3JyZXRhLnBuZyIsImlhdCI6MTc2ODM5NTI1NSwiZXhwIjoyMDUyMjE5MjU1fQ.lzdnuriOvN95IZsOLaiO-SZJLaCEMpWLRF9B8CEcibE";
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    if (isDetailed) {
      ...
      content = {
        ...
        theology: "A teologia da 'Presença Imunizante': José estava no Egito, um lugar de idolatria, mas a presença de Deus o tornava imune à decadência moral au seu redor. Isso nos ensina que o cristão não deve fugir do mundo, mas influenciá-lo através da excelência. A bênção de Deus sobre José transbordava para Potifar, revelando que o favor divino é um agente de transformação social e econômica.",
        ...
        spiritual: "Avalie se você tem sido um canal de bênção para as pessoas au seu redor, mesmo as que não compartilham da sua fé.",
